...
There is no starter code for this project. I used the Just Tech News code from Module 14 (14.5) as starter code in order to set up the initial structure.
...
Note: The express-session (Links to an external site.) package stores the session data on the client in a cookie. When you are idle on the site for more than a set time, the cookie will expire and you will be required to log in again to start a new session. This is the default behavior and you do not have to do anything to your application other than implement the npm package.
...
* Install express-handlebars package
* Install DOTENV package
* Install bcrypt package
* Insalll express-session package
* Install connect-session-sequelize package
* Install path package

## Set-up and Usage
Run the following commands at the root of your project and answer the questions when prompted

* mysql -u root -p (This enters mysql monitor)
- Enter password when prompted

* source db/schema.sql

* source db/seeds.sql (This populates the database)

* quit (This exits mysql monitor and returns back to your project root)

* npm run seed (This populate the database)
